...
const Login = () => {
    ...
    return (
        <div className="h-screen overflow-hidden bg-gray-100 text-gray-900 flex justify-center items-center">
            <div className="max-w-screen-xl m-4 sm:m-10 bg-white shadow-lg sm:rounded-lg flex justify-center flex-1">
                <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
                    <div className="text-center">
                        <img
                            src="/Images/logo.webp"
                            className="w-36 h-36 mt-16 mx-auto rounded-[100%]"
                            alt="Logo"
                        />
                    </div>
